...
Func Example()
	...
	MsgBox(0, "GS/XG Filter Params", "Press Ok to change the decay time. (if supported)")
	_midi_SetADSR_Decay($hDevice, $iChannel, 0x60)
	PlayNote($hDevice, $iChannel)


	_midi_SetADSR_Decay($hDevice, $iChannel)
