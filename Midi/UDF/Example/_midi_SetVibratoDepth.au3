...
Func Example()
	...
	MsgBox(0, "GS/XG Vibrato", "Press Ok to increase the vibrato depth (if supported)")
	_midi_SetVibratoDepth($hDevice, $iChannel, 0x70)
	Sleep(1500)
	...
	_midi_SetVibratoDepth($hDevice, $iChannel)
