...
Func Example()
	...
	MsgBox(0, "GS/XG Filter Params", "Press Ok to change the attack time. (if supported)")
	_midi_SetADSR_Attack($hDevice, $iChannel, 0x60)
	PlayNote($hDevice, $iChannel)

	_midi_SetADSR_Attack($hDevice, $iChannel)
