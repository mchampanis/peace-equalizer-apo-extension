...
Func Example()
	...
	MsgBox(0, "Modulation Depth Range", "Press OK to set the depth to 2 semitones. (if supported)")
	_midi_SetModDepthRange($hDevice, $iChannel, 2)
	Sleep(1500)
	...
	_midi_SetModDepthRange($hDevice, $iChannel)
