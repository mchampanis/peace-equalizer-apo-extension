...
Func Example()
	...
	MsgBox(0, "GS/XG Drum Params", "Press Ok to change the drum's reverb send level (if supported)")
	For $i = 0 To 0x7F Step 0x20
		_midi_SetDrumReverb($hDevice, $iChannel, $NTE_SNARE, $i)
		PlayDrum($hDevice, $NTE_SNARE)
	Next
	Sleep(500)

	_midi_SetDrumReverb($hDevice, $iChannel, $NTE_SNARE)
