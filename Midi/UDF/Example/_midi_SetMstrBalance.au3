...
Func Example()
	...
	MsgBox(0, "Master Balance", "Press OK to shift the balance from hard left to hard right (if supported).")
	For $i = 0 To 0x3FFF Step 127
		_midi_SetMstrBalance($hDevice, $i)
		Sleep(5)
	Next
