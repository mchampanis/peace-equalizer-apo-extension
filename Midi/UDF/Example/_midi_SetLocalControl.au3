...
Func Example()
	...
	MsgBox(0, "Local Control", "Press OK to turn off local control. (if supported)")
	_midi_SetLocalControl($hDevice, 0)
	MsgBox(0, "Local Control", "Message sent")

	_midi_SetLocalControl($hDevice, 1)
